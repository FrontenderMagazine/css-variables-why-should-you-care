...
расширения и создания полифилов для будущих возможностей CSS.
...
улучшения отзывчивого дизайна и возможность создания полифилов для будущих
возможностей CSS. С выходом Chrome 49, эти возможности стали доступны в виде
кастомных CSS-свойств.

## Кастомные свойства в двух словах

Кастомные свойства добавляют две новые возможности в наш инструментарий CSS:
